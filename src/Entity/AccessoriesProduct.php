...
/**
 * @ORM\Entity(repositoryClass=AccessoriesProductRepository::class)
 */
class AccessoriesProduct
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=ShoppingCart::class, mappedBy="accessoriesProduct")
     */
    ...
    public function addShoppingCart(ShoppingCart $shoppingCart): self
    {
        if (!$this->shoppingCarts->contains($shoppingCart)) {
            ...
            $shoppingCart->addAccessoriesProduct($this);
        }
